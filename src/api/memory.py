...
def parse_data(data: dict):
    # data: {"memory_date: ", "progress"}
    return str(data)


class Service:
    def __init__(self, db_dict: str, slot_name: str):
        self._dbman = DBManager.DbManager(db_dict)
    ...
    def reset(self):
        ...
        self._dbman.commit()
        print(MsgColor.MsgColor.OK, "successfully create slot: %s" % self._slot_name, MsgColor.MsgColor.END)
